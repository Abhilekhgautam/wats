...
public:
    VariableDeclarationAST(std::string type_name, const std::string variable_name, std::vector<SourceLocation> loc) :
        type_name(std::move(type_name)), variable_name(variable_name), loc(loc) {}
