...
std::map<std::string, TokenName> Lexer::keywords = {
        {"export", TokenName::EXPORT}, {"function", TokenName::FUNCTION}, {"where", TokenName::WHERE},
        {"from", TokenName::FROM},     {"import", TokenName::IMPORT},     {"i32", TokenName::I32},
        {"i64", TokenName::I64},       {"f32", TokenName::F32},           {"f64", TokenName::F64},
        {"let", TokenName::LET},       {"const", TokenName::CONST},       {"to", TokenName::TO},
        {"in", TokenName::IN},         {"for", TokenName::FOR},           {"while", TokenName::WHILE},
        {"loop", TokenName::LOOP},     {"match", TokenName::MATCH},       {"if", TokenName::IF},
        {"else", TokenName::ELSE},     {"break", TokenName::BREAK},       {"return", TokenName::RETURN},
        {"all", TokenName::ALL},       {"once", TokenName::ONCE}};
