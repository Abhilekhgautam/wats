...
std::ostream &operator<<(std::ostream &os, TokenName type) {
  ...
  case TokenName::NUM:
    os << "NUM";
    break;
  case TokenName::OPEN_PARENTHESIS:
    os << "OPEN_PARENTHESIS";
    break;
  case TokenName::CLOSE_PARENTHESIS:
    os << "CLOSE_PARENTHESIS";
    break;
  case TokenName::OPEN_SQUARE:
    os << "OPEN_SQUARE";
    break;
  case TokenName::CLOSE_SQUARE:
    os << "CLOSE_SQUARE";
    break;
  case TokenName::OPEN_CURLY:
    os << "OPEN_CURLY";
    break;
  case TokenName::CLOSE_CURLY:
    os << "CLOSE_CURLY";
    break;
